      ...
      <Route path="/test-chart" element={
        <ProtectedRoute>
          <div style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            {/* Review depth bar chart */}
            <div>
              <h2 style={{ marginBottom: '16px', fontSize: '16px', fontWeight: 600 }}>
                Review Depth by Author
              </h2>
              <ReviewDepthChart data={{
                authors: [
                  { authorUsername: 'danisha', totalPRs: 12, avgComments: 4.2, avgReviews: 2.1, avgChangesRequested: 0.8 },
                  { authorUsername: 'fardin', totalPRs: 8, avgComments: 2.5, avgReviews: 1.8, avgChangesRequested: 0.3 },
                  { authorUsername: 'miora', totalPRs: 5, avgComments: 6.0, avgReviews: 3.0, avgChangesRequested: 1.2 },
